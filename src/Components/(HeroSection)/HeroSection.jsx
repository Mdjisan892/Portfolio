...
import { LatestWorkButton } from "../Buttons";
import MyLogo from "./MyLogo";

function HeroSection() {
  return (
    <div className="w-full min-h-[90vh] relative  text-[#4C4F65] dark:text-white font-mono mt-10 md:-mt-5 overflow-hidden">
     
      <section className="flex m-3 p-3 justify-between items-center">
        <MyLogo />

        <ul className="flex flex-col gap-8 z-30 ">
          <li>
            <a href="https://x.com/JisanMomi" target="_blank" rel="noopener">
              <svg
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6 sm:w-10 sm:h-10 dark:hover:text-white/60 hover:text-gray-700 duration-300"
                viewBox="0 0 612 612"
              >
          ...
          <li>
            <a href="https://www.linkedin.com/in/md-jisan-hossain-mome/" target="_blank" rel="noopener">
              <svg
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6 sm:w-10 sm:h-10 dark:hover:text-white/60 hover:text-gray-700 duration-300"
          ...
          <li>
            <a href="https://github.com/Mdjisan892" target="_blank" rel="noopener">
              <svg
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6 sm:w-10 sm:h-10 dark:hover:text-white/60 hover:text-gray-700 duration-300"
          ...
          <li>
            <a href="mailto:mdjisan1012345@gmail.com" target="_blank" rel="noopener">
              <IoIosMail className="h-6 w-6 sm:h-10 sm:w-10 dark:hover:text-white/60 hover:text-gray-700 duration-300"/>
            </a>
          </li>
        </ul>
      </section>
